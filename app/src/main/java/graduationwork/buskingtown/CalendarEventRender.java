...
public class CalendarEventRender extends EventRenderer<CalendarEvent> {

    @Override
    public void render(View view, CalendarEvent event) {
    ...
    public int getEventLayout() {
        return R.layout.calendarevent;
    }

    public Class<CalendarEvent> getRenderType(){
