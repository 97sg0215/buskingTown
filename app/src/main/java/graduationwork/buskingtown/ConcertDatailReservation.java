...
public class ConcertDatailReservation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_concert_datail_reservation);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { ConcertDatailReservation.super.onBackPressed(); }
        });
        ...
        practiceStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(ConcertDatailReservation.this,R.style.MyDatePickerDialogTheme, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public void next(int provide_id, int provide_option, String practice_date, String start_time, String end_time, int fee,
        ...
        Intent checkReservation = new Intent(this, ConcertReservationCheck.class);
